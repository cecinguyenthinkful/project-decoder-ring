const polybiusModule = (function () {
  const encodeKey = { //create collection of key values
    a: 11, b: 21, c: 31, d: 41, e: 51,
    f: 12, g: 22, h: 32, i: 42, j: 42, k: 52, //translates i and j to 42
  ...
  const decodeKey = {
    ...
    12: "f", 22: "g", 32: "h", 42: "(i/j)", 52: "k", //translates 42 to i/j
    13: "l", 23: "m", 33: "n", 43: "o", 53: "p",
    14: "q", 24: "r", 34: "s", 44: "t", 54: "u",
    15: "v", 25: "w", 35: "x", 45: "y", 55: "z",
  }
  function polybius(input, encode = true) {
    input = input.toLowerCase(); //ignores capital letters
    let splitString;
    let key = encodeKey;
    if(encode) {
